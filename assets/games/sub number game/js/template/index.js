...
const animateAns = (num1, num2, res) => {
  ...
  appState.answers
    .to("#res .cover", {
      ...
      ease: "power1.inOut",
      y: "-100%",
      onStart: () => console.log("animate ans started"),
    })
 ...
 */
function ansClickHandler(ans, res) {
  if (ans !== res) {
    return;
  }
...
function handleClicks(resultObj) {
  ...
  $("#ans1")
    .click(() => answerClick(ans1, res))
    .attr("data-answer", ans1 === res)
    .children()
    .text(ans1);

  $("#ans2")
    .click(() => answerClick(ans2, res))
    .attr("data-answer", ans2 === res)
    .children()
    .text(ans2);
  $("#ans3")
    .click(() => answerClick(ans3, res))
